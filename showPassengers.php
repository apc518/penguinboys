    ...
    <?php
        ...
        try {
            ...
            foreach($result_set as $tuple) {
              echo "<font color='#d0d'>$tuple[ssn]</font> $tuple[f_name] $tuple[m_name] $tuple[l_name] <a href='index.html?f_name=$tuple[f_name]&m_name=$tuple[m_name]&l_name=$tuple[l_name]&passenger_ssn=$tuple[passenger_snn]'>update</a><br/>\n";
            }
